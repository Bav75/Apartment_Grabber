...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Apartment Grabber is a test gem, designed to scrape Craigslist and grab apartment rental listings.}
  spec.description   = %q{Apartment Grabber is a test gem, designed to scrape Craigslist and grab apartment rental listings.}
